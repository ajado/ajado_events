 ...
 */
class Tx_AjadoEvents_ViewHelpers_Format_DateTimeViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	protected function modifyDate($timestamp, $get) {
		return Tx_AjadoEvents_ViewHelpers_Format_StrToTime::strtotime($get, $timestamp);
	}
}
?>